defmodule SunsilkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SunsilkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SunsilkWeb.Gettext, "errors", msg, opts)
    end
  end
